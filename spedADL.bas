...
2255 VDU 23,16,1,1 : REM disable screen scroll off the bottom
2260 PROCshort(11,v%+3,"","[]","rot"): PROCshort(17,v%+3,"","~","flip"): PROCshort(23,v%+3,"","#","mirro"): PROCshort(30,v%+3,"s","H","ift"): PROCshort(36,v%+3,"r","O","ll")
2265 VDU 23,16,1,1 : REM reenable screen scroll off the bottom
2280 ENDPROC
...
30020 VDU 23, 0, 192, 1 : REM turn on normal logical screen scaling
30030 VDU 23, 1, 1 : REM enable text cursor
30040 @%=&90A
30050 COLOUR 15
30060 IF ISEXIT=0 PRINT:REPORT:PRINT " @ line ";ERL:END
30070 PRINT : PRINT "Goodbye"
30080 END
