 ...
 5350 PRINT TAB(0,l%); :COLOUR 15: PRINT "C"; : COLOUR C1: PRINT" to configure, ";
 5355 COLOUR 15:PRINT "RETURN";:COLOUR C1:PRINT" to continue.";:COLOUR 15: INPUT in_str$
 ...
 5410 COLOUR C1: PRINT TAB(0,line%);"Sprite Size  : "; : COLOUR C2
 5420 IF CONFIG_SIZE=2 THEN PRINT "8x8" ELSE PRINT "16x16"
 5425 line%=line%+1
 5430 COLOUR C1: PRINT TAB(0,line%);"Joystick     : "; : COLOUR C2
 5440 IF CONFIG_JOY=1 THEN PRINT "Enabled" ELSE PRINT "Disabled"
 5445 line%=line%+1
 5450 IF CONFIG_JOY=1 THEN COLOUR C1 : PRINT "Joy Delay    : ";:COLOUR C2 : PRINT ;CONFIG_JOYDELAY;: line%=line%+1
 5460 COLOUR C1: PRINT TAB(0,line%);"Editing type : "; : COLOUR C2
 ...
 6820 IF bw% <> bh% THEN COLOUR1:PRINT TAB(30,FLINE%);"not square"; : ENDPROC
 6825 FOR y%=y1% TO y2%
 6830   FOR x%=x1% TO x2%
 6835     ic%=x%+y%*W%
